...
p = {
	...
	draw = function(self,explorer) -- use this to draw, write text, etc. You can use cls() without issues as well if you want a different bg
		...
		self.mygif:draw(2,2,3,0)-- you need to specify position, speed, and alpha when drawing gif
		self.mygif:draw(18,2,3,0)
		self.mygif:draw(34,2,3,0)
		self.mygif:draw(50,2,3,0)
		self.smile:draw(120,74,1,0)
	end,
