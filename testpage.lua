--[[	Thanks for using PicoNet Sitebuilder! I look forward
	...
	init = function(self,explorer)
		...
		self.untitled2btn = self.g:attach({
			x=183.0, y=44.0, width=16, height=16,
		...
		self.untitled3btn = self.g:attach({
			x=58.0, y=35.0, width=16, height=16,
			event = function(self,msg)
				if(msg.event == "release") then
					set_clipboard(pod({type="gif", w=16, h=16, frames=12, speed=1, clr=0, imgdata="b64:bHo0ALcBAAAQAwAA-AJweHUAQyDAEATwtD8WsE7ALgIA-wCgTpAOLw8ekA4tLqAOHR4EAA3-BYAOLS5wLi0OkB4tHpAeLQ4NgC4dBQAOACgA-wVwHi0ecH6AfoBugA4fIA4cDoAOHAYAD7ducH5gBR4cDhyAHhYADwYAHBFwPACAcAUOHA0MDYAHAAUgAD8uDC4EAAYVDjYAAAcAgS4MDqAuDB6QHgAfCQQACAE_"})
					notify("gif added to clipboard")
		...
		self.untitled6btn = self.g:attach({
			x=150.0, y=60.0, width=16, height=16,
			event = function(self,msg)
				if(msg.event == "release") then
					set_clipboard(pod({type="gif", w=16, h=16, frames=12, speed=1, clr=0, imgdata="b64:bHo0ALcBAAAQAwAA-AJweHUAQyDAEATwtD8WsE7ALgIA-wCgTpAOLw8ekA4tLqAOHR4EAA3-BYAOLS5wLi0OkB4tHpAeLQ4NgC4dBQAOACgA-wVwHi0ecH6AfoBugA4fIA4cDoAOHAYAD7ducH5gBR4cDhyAHhYADwYAHBFwPACAcAUOHA0MDYAHAAUgAD8uDC4EAAYVDjYAAAcAgS4MDqAuDB6QHgAfCQQACAE_"})
					notify("gif added to clipboard")
		...
		self.untitled9btn = self.g:attach({
			x=97.0, y=28.0, width=24, height=24,
			event = function(self,msg)
				if(msg.event == "release") then
		...
		self.untitled10btn = self.g:attach({
			x=101.0, y=33.0, width=16, height=16,
			event = function(self,msg)
				if(msg.event == "release") then
					set_clipboard(pod({type="gif", w=16, h=16, frames=12, speed=1, clr=0, imgdata="b64:bHo0ALcBAAAQAwAA-AJweHUAQyDAEATwtD8WsE7ALgIA-wCgTpAOLw8ekA4tLqAOHR4EAA3-BYAOLS5wLi0OkB4tHpAeLQ4NgC4dBQAOACgA-wVwHi0ecH6AfoBugA4fIA4cDoAOHAYAD7ducH5gBR4cDhyAHhYADwYAHBFwPACAcAUOHA0MDYAHAAUgAD8uDC4EAAYVDjYAAAcAgS4MDqAuDB6QHgAfCQQACAE_"})
					notify("gif added to clipboard")
		...
		self.untitled11btn = self.g:attach({
			x=199.0, y=102.0, width=16, height=16,
			event = function(self,msg)
				if(msg.event == "release") then
					set_clipboard(pod({type="gif", w=16, h=16, frames=12, speed=1, clr=0, imgdata="b64:bHo0ALcBAAAQAwAA-AJweHUAQyDAEATwtD8WsE7ALgIA-wCgTpAOLw8ekA4tLqAOHR4EAA3-BYAOLS5wLi0OkB4tHpAeLQ4NgC4dBQAOACgA-wVwHi0ecH6AfoBugA4fIA4cDoAOHAYAD7ducH5gBR4cDhyAHhYADwYAHBFwPACAcAUOHA0MDYAHAAUgAD8uDC4EAAYVDjYAAAcAgS4MDqAuDB6QHgAfCQQACAE_"})
					notify("gif added to clipboard")
		...
		self.untitled12btn = self.g:attach({
			x=194.0, y=100.0, width=24, height=24,
			event = function(self,msg)
				if(msg.event == "release") then
					set_clipboard("b64:bHo0AHUAAACIAAAA8B1weHUAQyAYGAT3VZ8gDccOhx23Dgd2DQcNpw4HJhMmDRcNlw4HFgMLAwEWPgoAsSMBNgcOlw4HJhFGCABBVi8QAQkAcwYINgwPDAwNAGIPDggmHBEMAEIaCBYxCgAiKgg1ACIGMQgAsJYHDpcOtw6X3vdV")
					notify("image userdata added to clipboard")
	...
	draw = function(self,explorer)
		cls(0)
		untitled2:draw(183.0,44.0,16,16,1,0)
		untitled2:draw(58.0,35.0,16,16,1,0)
		rectfill(155.0,35.0,195.0,75.0,8)
		ovalfill(61.0,77.0,101.0,117.0,8)
		untitled2:draw(150.0,60.0,16,16,1,0)
		print("select \"text\"\nunder \"edit\" ",80.0,91.0,7)
		ovalfill(89.0,107.0,129.0,147.0,8)
		palt(0)
		palt(0, true)
		sspr(self.untitled9, 0, 0, 24,24,97.0,28.0,24,24)
		palt()
		untitled2:draw(101.0,33.0,16,16,1,0)
		untitled2:draw(199.0,102.0,16,16,1,0)
		palt(0)
		palt(0, true)
		sspr(self.untitled9, 0, 0, 24,24,194.0,100.0,24,24)
		palt()
	...
	untitled9 = unpod("b64:bHo0AHUAAACIAAAA8B1weHUAQyAYGAT3VZ8gDccOhx23Dgd2DQcNpw4HJhMmDRcNlw4HFgMLAwEWPgoAsSMBNgcOlw4HJhFGCABBVi8QAQkAcwYINgwPDAwNAGIPDggmHBEMAEIaCBYxCgAiKgg1ACIGMQgAsJYHDpcOtw6X3vdV")
}
