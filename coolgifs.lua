p = {
	...
	draw = function(self,explorer) -- use this to draw, write text, etc. You can use cls() without issues as well if you want a different bg
		...
		print("\n\n"..
			...
			"Here you go:", 10,0,7)
		self.spin_cartridge:draw(2,180,16,16,3,0)-- you need to specify position, speed, and alpha when drawing gif
		self.smile:draw(20,180,16,16,1,0)
		self.sad:draw(38, 180,16,16,1,0)
		self.sunglasses:draw(56, 180,16,16,2,0)
		self.the_mystical_trumpeting_skeleton:draw(74,180,16,16,1,0)
		self.kirby_blink:draw(92, 180,16,16,3,0)
	end,
